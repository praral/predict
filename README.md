...
_Import [THIS](https://github.com/PipelineAI/predict/blob/r1.3/dashboard/grafana/pipeline-predict.json) json file for your PipelineAI Prediction dashboard._
